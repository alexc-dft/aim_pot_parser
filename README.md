...
For the case of default.in, it is designed around a 1x1x1 simple cubic diamond system with a single lattice parameter of 6.74 Bohr and a sampling density of 36 data points in all dimensions of the unit cell.  
For simplicity the grid vectors are aligned with the lattice vectors.  
